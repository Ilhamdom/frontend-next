          ...
          <div className="bg-white/90 rounded-2xl border border-blue-200 p-8 flex flex-col shadow-lg">
            ...
            <ul className="space-y-4 mt-2">
              <li className="flex items-start gap-2">
                ...
                <span className="text-blue-900">Meningkatkan kualitas SDM aparatur negara.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 text-yellow-500">
                  <svg width="18" height="18" fill="none" viewBox="0 0 18 18"><circle cx="9" cy="9" r="7" stroke="currentColor" strokeWidth="2"/></svg>
                </span>
                <span className="text-blue-900">Mengembangkan inovasi tata kelola pemerintahan.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 text-yellow-500">
                  <svg width="18" height="18" fill="none" viewBox="0 0 18 18"><circle cx="9" cy="9" r="7" stroke="currentColor" strokeWidth="2"/></svg>
                </span>
                <span className="text-blue-900">Memperkuat sistem pengawasan dan akuntabilitas.</span>
              </li>
            </ul>
          </div>
        </div>
